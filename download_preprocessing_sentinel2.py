...
choice = raw_input("Please enter the cloud coverage percentage : ")
...
if choice_study == 'One image analysis':
    ...
    sen2three = sp.GPF.createProduct('Sen2Three', parameters)

    print("Sen2Three executing at " + time.ctime())
    print_processing_time(begintime_sen2three, "Sen2Three processing achieved in ")

    ## Sen2Three stand-alone needs to be already installed in order for this line to execute correctly
    ## Uncomment if precedent lines didn't work for Sen2Three
    # import os
    ...
    begintime_export = time.time()
    print ("Executing export at " + time.ctime() + " for data")

    export = sp.ProductIO.writeProduct(sen2three,'F:\\snap\\sen2three\\' + item, 'GeoTIFF')

    print("Image exporting finishing at " + time.ctime())
    print_processing_time(begintime_export, "Image export achieved in ")
